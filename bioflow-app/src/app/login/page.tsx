...
export default function LoginPage() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signUpError) {
        // Se a conta já existir, ele tenta fazer o login normal
      ...
      // 2. LÓGICA INTELIGENTE: Verifica se o perfil já existe
      if (authUser) {
        ...
        <div className="!flex-1 !flex !items-center !justify-center !w-full !mt-12">
          ...
          <div className="!w-full !max-w-[420px] !flex !flex-col !py-8">
            ...
            <div className="!flex !flex-col !gap-3">
              <button type="button" className="!w-full !h-14 !bg-white !text-black !font-bold !rounded-full !border !border-gray-200 hover:!border-gray-400 hover:!bg-gray-50 !transition-all !flex !items-center !justify-center !gap-3 !text-base">
